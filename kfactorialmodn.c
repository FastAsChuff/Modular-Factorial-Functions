...
// getkfactmodn1() - k,n < 2^64 (Slowest)
// getkfactmodn6() - n < 2^64, k < 2^32, n must be odd and array primes must contain all primes <= k in ascending order.(Fastest)
// getkfactmodn3() - k,n < 2^64, n must be odd. Define macro KFACTORIALMODUSEMG to use this function.
